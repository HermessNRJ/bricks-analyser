 ...
 */
const NOMS = [
    ['Immeuble Verdurin', 'Rue des Trois-Ponts, 44000 Nantes', 'France'],
    ['Villa des Alizés', 'Chemin du Phare, 35400 Saint-Malo', 'France'],
    ['Maisons du Clos Rivard', 'Route de Bellevue, 49000 Angers', 'France'],
    ['Résidence Le Pommeret', 'Avenue Jean-Jaurès, 35000 Rennes', 'France'],
    ['Domaine de la Ferrandière', 'Lieu-dit La Ferrandière, 30700 Uzès', 'France'],
    ['Hôtel du Cap Lauzet', 'Corniche des Douaniers, 34200 Sète', 'France'],
    ['Division Rue Chanzy', 'Rue Chanzy, 51100 Reims', 'France'],
    ['Immeuble Sainte-Colombe', 'Place Sainte-Colombe, 21000 Dijon', 'France'],
    ['Chalet des Grandes Combes', 'Route des Crêtes, 74110 Morzine', 'France'],
    ['Appartements Quai Neuf', 'Quai Neuf, 33000 Bordeaux', 'France'],
    ['Manoir de Kerlann 🇫🇷', 'Route de Kerlann, 56000 Vannes', 'France'],
    ['Locaux Parc de Bellecour', 'Zone du Bellecour, 63000 Clermont-Ferrand', 'France'],
    ['Villa Aurore', 'Boulevard du Midi, 06600 Antibes', 'France'],
    ['Immeuble Faubourg Lamartine', 'Faubourg Lamartine, 87000 Limoges', 'France'],
    ['Gîtes de la Vallée Close', 'Vallée Close, 09000 Foix', 'France'],
    ['Maison de la Poterne', 'Rue de la Poterne, 10000 Troyes', 'France'],
    ['Résidence Les Tamaris', 'Allée des Tamaris, 17000 La Rochelle', 'France'],
    ['Division Route de Sainval', 'Route de Sainval, 80000 Amiens', 'France'],
    ['Entrepôts du Pont Vieux', 'Chemin du Pont Vieux, 34500 Béziers', 'France'],
    ...
    ['Le Sextant', 'Rue du Sextant, 29200 Brest', 'France'],
    ['Immeuble Bréhat', 'Quai de Bréhat, 22000 Saint-Brieuc', 'France'],
    ['Ferme des Quatre Vents', 'Route des Quatre Vents, 46000 Cahors', 'France'],
    ['Maisons Pré Fleuri', 'Chemin du Pré Fleuri, 73000 Chambéry', 'France'],
    ['Appartements Grand Bassin', 'Rue du Grand Bassin, 76600 Le Havre', 'France'],
    ['Division Clos Marronnier', 'Clos du Marronnier, 45000 Orléans', 'France'],
    ['Hôtel de la Poste Neuve', 'Place de la Poste, 46000 Cahors', 'France'],
    ['Villa Bellisandre', 'Corniche Bellisandre, 13260 Cassis', 'France'],
    ['Immeuble Rive Basse', 'Quai Rive Basse, 57000 Metz', 'France'],
    ['Résidence des Fontenelles', 'Rue des Fontenelles, 37000 Tours', 'France'],
    ['Domaine du Haut Ségur', 'Route du Haut Ségur, 12000 Rodez', 'France'],
    ['Appartement Cais Velho 🇵🇹', 'Cais Velho, Setúbal', 'Portugal'],
    ['Locaux du Verger Nord', 'Zone du Verger, 59300 Valenciennes', 'France'],
    ['Maison Terre Rouge', 'Chemin de Terre Rouge, 66000 Perpignan', 'France'],
    ['Immeuble Trois Fontaines', 'Rue des Trois Fontaines, 54000 Nancy', 'France'],
    ['Villa des Rochers Blancs', 'Route des Rochers, 64200 Biarritz', 'France'],
    ['Résidence Pointe Sud', 'Avenue de la Pointe, 20000 Ajaccio', 'France'],
    ['Division Faubourg Pasteur', 'Faubourg Pasteur, 25000 Besançon', 'France']
];
